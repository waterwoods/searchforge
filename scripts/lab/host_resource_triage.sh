#!/bin/bash
# =============================================================================
# LAB ONLY — host/Docker resource sampling (SearchForge lab containers)
# Product path: bash scripts/run_demo_local.sh  (port 8001)
# Moved from repo root triage.sh — NOT intake triage logic
# =============================================================================
