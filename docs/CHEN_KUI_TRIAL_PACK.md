...
*See also: `docs/STANDARD_SCENARIO_PACKAGE.md` (canonical package definition), `docs/UNIFIED_INTAKE_DEMO_READINESS.md`, `docs/runbooks/UNIFIED_INTAKE_MVP_RUNBOOK.md`, `docs/TRUSTED_ASSISTANT_PLATFORM_BLUEPRINT.md`*
