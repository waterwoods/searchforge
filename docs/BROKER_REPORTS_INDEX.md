...
| Report | Purpose |
|--------|---------|
| [Mature Skeleton / Commercial Intake Backbone Report](./sprints/MATURE_SKELETON_COMMERCIAL_INTAKE_BACKBONE/MATURE_SKELETON_COMMERCIAL_INTAKE_BACKBONE_REPORT.md) | Mature backbone: borrow Stripe/Amazon/Intercom/Zendesk; 4 backbones (Page, Flow, State, Handoff); borrow-vs-build; defer list; 7 control docs; Loop 1–3 |
| [Product Value Review Sprint Report](./sprints/PRODUCT_VALUE_REVIEW_SPRINT/PRODUCT_VALUE_REVIEW_REPORT.md) | Value-based prioritization: 10 candidates scored; Trial Execution + Fix-Next = best next sprint; OCR = trap; 7 control docs |
| [Add-Car Quote Excellence Sprint Report](./sprints/ADD_CAR_QUOTE_EXCELLENCE_SPRINT/ADD_CAR_QUOTE_EXCELLENCE_SPRINT_REPORT.md) | Add-car star scenario: concrete vehicle in broker_next_step; coverage side-question handling; ask_driver_only config; HT11/HT12 simulations; 7 control docs |
| [Mixed-Intent + Secondary Case Strategy Report](./sprints/MIXED_INTENT_SECONDARY_CASE_SPRINT/INDEX.md) | Mixed-intent handling: primary vs secondary; "Also asked" in summary; secondary_issue_note; 14/14 mixed-intent sim pass; broker visibility |
| [Handoff Timing Regression + Redeploy Report](./sprints/HANDOFF_TIMING_REGRESSION_REDEPLOY/HANDOFF_TIMING_REGRESSION_REDEPLOY_REPORT.md) | Handoff timing regression: 10 flows; premium/payment "one more ask" deferred (breaks 2-turn); fix-next 3+ turn scope; 7 control docs |
| [Broker Trial Simulation + Fix Queue Hardening Report](./sprints/BROKER_TRIAL_SIMULATION_FIX_QUEUE_HARDENING/BROKER_TRIAL_SIMULATION_FIX_QUEUE_HARDENING_REPORT.md) | Broker-style simulation; 8 stress flows (vague, talk-to-agent, already-sent, correction); fix queue hardening; guardrail step 8b; Loop 1–3 |
...
| [Workbench Handoff Readiness Report](./sprints/archive/workbench_handoff_readiness/WORKBENCH_HANDOFF_READINESS_REPORT.md) *(archived)* | Workbench handoff readiness: Recent customer messages, correction/already_sent badges; 7 control docs; Loop 1–2; broker can understand case faster |
| [Workbench Handoff Professionalization + Trial Hardening Report](./sprints/WORKBENCH_HANDOFF_PROFESSIONALIZATION_TRIAL_HARDENING/WORKBENCH_HANDOFF_PROFESSIONALIZATION_TRIAL_HARDENING_REPORT.md) | Workbench professionalization: queue cards show quote_ready, correction, already_sent, contact needed; broker_next_step concrete for remove-vehicle; BS9/BS10; 8 control docs; Loop 1–3 |
| [Workbench Office Tool Professionalization Report](./sprints/WORKBENCH_OFFICE_TOOL_PROFESSIONALIZATION/WORKBENCH_OFFICE_TOOL_PROFESSIONALIZATION_REPORT.md) | Office tool professionalization: queue cards show broker_next_step preview, follow-up prominence; case detail follow-up block above fold; BS13; 9 control docs; Loop 1–3 |
| [Add-Car Commercial Flow Hardening Report](./sprints/ADD_CAR_COMMERCIAL_FLOW_HARDENING/ADD_CAR_COMMERCIAL_FLOW_HARDENING_REPORT.md) | Add-car full-module hardening: add-car + materials sent (发你微信了) → broker_next_step "Verify materials received"; warmer handoff reply; materials_sent skips driver ask; BS11/BS12, MT51, HT13; 9 control docs; Loop 1–3 |
