...
| 2 | Archive sprint doc noise | `docs/sprints/archive/**`, `docs/sprints/README.md`, moved sprint paths | Low | Less agent/founder confusion from stale sprints | `git status`, grep broken refs | `git mv` back from archive | pending |
