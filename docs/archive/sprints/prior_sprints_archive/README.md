...
| `p2_role_c_d_battery_sprints/` | Role C/D live batteries, simulation validation, deploy proof sprints |
| `p2_reply_flow_polish_sprints/` | Reply externalization, flow polish, UI density sprints |
...
| p2-simplification-loops | 2026-05-26 | ~50 Role C/D + reply/flow polish dirs |
