"""
Concurrency actuator for control flow shaping.

Adjusts max concurrent requests with hard caps and gray rollout.
"""
...
class ConcurrencyActuator(Actuator):
    """
    Concurrency control actuator.
    
    Adjusts max concurrency with:
    ...
    async def apply(self, adjustment: float, reason: str) -> Dict[str, Any]:
        ...
        # (in practice, this would be done by the executor)
